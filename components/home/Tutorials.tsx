...
export function Tutorials({ lang, t }: Props) {
  ...
  return (
    <section id="tutorials" className="bg-opc-dark py-16 md:py-24 px-5 md:px-6 border-t border-white/5">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-serif text-3xl md:text-4xl font-black text-white mb-6 md:mb-8 tracking-tight">
          {t.heading}
        </h2>
          ...
          {filtered.map((tut) => {
            ...
            return (
              <Link key={tut.slug} href={`/${lang}/tutorials/${tut.slug}`}
                    className="bg-white/5 border border-white/8 rounded-xl p-5 md:p-6 hover:bg-white/8 transition-colors group">
                ...
                <h3 className="font-serif text-base md:text-lg font-bold text-white mb-2 md:mb-3 group-hover:text-opc-orange transition-colors leading-snug">
                  {title}
                </h3>

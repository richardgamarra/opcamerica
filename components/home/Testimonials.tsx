      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {TESTIMONIALS.map(({ quote, name, role, flag, country }) => (
            <div key={name} className="bg-white/5 border border-white/8 rounded-xl p-6 md:p-7">
              <p className="font-sans text-white/70 leading-relaxed mb-5 md:mb-6 text-sm italic">&ldquo;{quote}&rdquo;</p>

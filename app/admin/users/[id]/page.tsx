      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              {user.plan === "elite" ? "OPC Elite member" : "Free plan"}
            </p>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              {user.status === "active" ? "User can access the platform" : "User is blocked from signing in"}
            </p>
          </div>
        ...
        <div className="pt-5 border-t border-gray-800">
          ...
          <form className="flex gap-2">
            ...
            <button
              type="submit"
              className="bg-gray-700 hover:bg-gray-600 text-white font-semibold text-sm px-4 py-2 rounded-lg transition-colors whitespace-nowrap"
            >
              Reset
            </button>
          </form>

...
function TypeIcon({ type }: { type: string }) {
  ...
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={TYPE_STROKE[type] ?? "#6b7280"} strokeWidth="2">
        ...
        <>
          ...
          <div className="grid grid-cols-4 gap-3 mb-6">
            {(["podcast", "ai", "webpage", "youtube"] as const).map((type) => {
              ...
              return (
                <div key={type} className="bg-white border border-gray-100 rounded-xl px-3 py-3 flex items-center gap-2">
                ...
                <div className="space-y-2">
                  {typeItems.map((item) => (
                    <a
                      ...
                      className="bg-white border border-gray-100 rounded-xl p-4 flex items-start gap-3 hover:border-gray-200 hover:shadow-sm transition-all block"
                    >
